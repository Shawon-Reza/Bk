            ...
            <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
                ...
                <div className="p-4 border-b border-gray-200">
                    <div
                        ...
                        <span
                            className="text-sm font-medium text-blue-900">1 request</span>
                    </div>
                </div>
                        ...
                        <div className="bg-white border-b border-gray-200 p-4 shadow-4xl ">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                    <button
                                        onClick={() => {
                                            navigate(`/brand-dashboard/influencers/${id}/send-proposal
`)
                                        }}
                        ...
                        {showChatRequest ? (
                            ...
                            <div className="flex-1 flex items-center justify-center p-8">
                                <div className="max-w-md w-full text-center">
                                    ...
                                    <h2 className="text-xl font-semibold text-gray-900 mb-2">{mockChatRequest.requester}</h2>
                                    <p className="text-gray-600 mb-6">({mockChatRequest.email}) {mockChatRequest.message}</p>
                            ...
                            <div className="flex-1 overflow-y-auto p-4 space-y-4">
                                {messages.map((message) => (
                                    <div key={message.id} className={`flex ${message.isOwn ? "justify-end" : "justify-start"}`}>
                                        <div
                                            className={`max-w-xs lg:max-w-md px-4 py-2 rounded-lg ${message.isOwn ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-900"
                                                }`}
                                        >
