...
//   const router = useRouter()
  ...
  const handleSubmit = () => {
    ...
    alert("Brand profile setup completed! (This will be replaced with API call)")
  }
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className=" mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Brands Profile Setup</h1>
            <p className="text-gray-600 mt-1">Complete your Brands profile to connect with Micro-Influencers</p>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-lg font-semibold text-gray-900">Basic Profile Information</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-md p-6 text-center hover:border-gray-400 transition-colors">
                  ...
                  {formData.logo && <p className="text-sm text-green-600 mt-2">Selected: {formData.logo.name}</p>}
                </div>
              </div>
            ...
            <div className="mt-6">
              <label className="block text-sm font-medium text-gray-700 mb-2">Business Profile Description</label>
              <textarea
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* X Handle */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">X Handle</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <span className="text-black">❌</span>
                  </div>
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-gray-600">Get an email when your profile receives a market match</p>
              </div>
