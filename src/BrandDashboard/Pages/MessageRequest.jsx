...
const mockNotifications = [
    {
        ...
        message: 'New Campaign Invite - Glow Beauty Co. invited you to collaborate on "Winter Radiance Serum."',
        avatar: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQH6JImtRr_PORjJojfyorJksXR84hWSXq9yg&s",
        time: "2h ago",
        isNew: true,
    },
    {
...
export default function MessageRequest() {
    ...
    const messageRequests = notifications.filter((n) => n.type === "collaboration");
    const requestCount = messageRequests.length;

    const filteredNotifications = filter === "requests" ? messageRequests : notifications;
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 mt-1">You've {requestCount} message request</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-4">
                        <a
            ...
            <div className="p-6">
                ...
                <div className="flex gap-2 mb-6">
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-colors ${filter === "requests" ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"
                            }`}
                    >
                ...
                <div className="space-y-4">
                    {filteredNotifications.map((notification) => (
                        <div
                            key={notification.id}
                            onClick={() => {
                                navigate('/brand-dashboard/message-request-permission')
                            }}
                            className={`cursor-pointer bg-white rounded-lg p-4 border transition-colors hover:bg-gray-50 ${notification.isNew ? "border-blue-200 bg-blue-50/30" : "border-gray-200"
                                }`}
                        >
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-start justify-between gap-4">
                                        <div className="flex-1">
                                            <h3 className="font-semibold text-gray-900 mb-1">{notification.brand}</h3>
                ...
                <div className="text-center mt-8">
                    <button className="text-sm text-gray-600 hover:text-gray-900 font-medium">see more...</button>
                </div>
            </div>
        </div>
    );
