...
const mockInfluencerData = {
    1: {
        ...
        creatorType: "Fashion Stylist, Beauty Guru, Lifestyle Creator, or Content Educator",
        contact: {
            name: "Maya Fashionista",
        ...
        campaigns: [
            ...
            },
            {
                ...
                description: "Feature our automation dashboard in your most compelling content for maximum user adoption",
                deadline: "Dec 15, 2024",
                status: "Active",
            },
        ],
...
export default function InfluencerProfile() {
    ...
    const handleBack = () => {
        ...
        navigate('/brand-dashboard/microinfluencerspage')
    }
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="bg-white rounded-lg border border-gray-200 p-6">
                                <h2 className="text-lg font-semibold text-gray-900 mb-4">About the Creator</h2>
                                <p className="text-gray-600 mb-4">{influencer.about}</p>
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <h3 className="font-medium text-gray-900 mb-2">Creator Type</h3>
                                    <p className="text-gray-600 text-sm">{influencer.creatorType}</p>
                                </div>
                            </div>

                            {/* Collaboration Performance */}
                            <div className="bg-white rounded-lg border border-gray-200 p-6">
                                <h2 className="text-lg font-semibold text-gray-900 mb-4">Collaboration Performance</h2>
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <div className="bg-slate-800 text-white p-4 rounded-lg text-center">
                                        <div className="text-2xl font-bold text-orange-400">{influencer.performance.totalCampaigns}</div>
                                        <div className="text-sm text-gray-300">Total Campaigns</div>
                                    </div>
                                    <div className="bg-slate-800 text-white p-4 rounded-lg text-center">
                                        <div className="text-2xl font-bold text-orange-400">{influencer.performance.engagementRate} %</div>
                                        <div className="text-sm text-gray-300">Engagement Rate</div>
                                    </div>
                                    <div className="bg-slate-800 text-white p-4 rounded-lg text-center">
                                        <div className="text-2xl font-bold text-orange-400">{influencer.performance.avgRating}</div>
                                    ...
                                    <div className="bg-slate-800 text-white p-4 rounded-lg text-center">
                                        ...
                                        <div className="text-sm text-gray-300">Previous Engagements</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="space-y-4">
                                    {influencer.campaigns.map((campaign) => (
                                        <div key={campaign.id} className="border border-gray-200 rounded-lg p-4">
                                            ...
                                            <p className="text-gray-500 text-xs">Deadline: {campaign.deadline}</p>
                                        </div>
                                    ))}
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-lg border border-gray-200 p-6">
                                <h2 className="text-lg font-semibold text-gray-900 mb-4">Reviews & Testimonials</h2>
                                <div className="flex items-center mb-4">
                                    <div className="text-3xl font-bold text-gray-900 mr-2">{influencer.reviews.rating}</div>
                                    <div>
                                        ...
                                        <div className="text-sm text-gray-500">Based on {influencer.reviews.totalReviews} reviews</div>
                                    </div>
                                </div>
                                <div className="space-y-4">
                                    {influencer.reviews.testimonials.map((testimonial) => (
                                        <div key={testimonial.id} className="border-l-4 border-green-400 pl-4">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white rounded-lg border border-gray-200 p-6">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <div className="font-medium text-gray-900">{influencer.contact.name}</div>
                                            <div className="text-sm text-gray-500">{influencer.contact.title}</div>
                                        </div>
                                    </div>
                                    <div className="flex items-center">
                                        <svg className="w-4 h-4 text-gray-400 mr-3" fill="currentColor" viewBox="0 0 20 20">
                                        ...
                                        <span className="text-gray-600">{influencer.contact.email}</span>
                                    </div>
                                    <div className="flex items-center">
                                        <svg className="w-4 h-4 text-gray-400 mr-3" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                                        </svg>
                                        <span className="text-gray-600">{influencer.contact.phone}</span>
                                    </div>
                            ...
                            <div className="bg-white rounded-lg border border-gray-200 p-6">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        <h3 className="font-medium text-gray-900 mb-2">Content Types</h3>
                                        <div className="space-y-1">
                                            {influencer.campaignInfo.contentTypes.map((type, index) => (
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600">{influencer.campaignInfo.budgetRange}</p>
                                    </div>
                                </div>
                            </div>
