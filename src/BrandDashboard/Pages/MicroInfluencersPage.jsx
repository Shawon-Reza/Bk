...
export default function MicroInfluencersPage() {
    ...
    const handleViewProfile = (creatorId) => {
        ...
        navigate(`/brand-dashboard/influencers/${creatorId}`);
            ...
            <div className="flex-1">
                ...
                <div className="bg-white px-8 py-6 ">
                    <div className="flex items-center justify-between">
                        <h1 className="text-2xl font-semibold text-gray-900">Discover Micro-Influencers</h1>
                ...
                <div className="p-8">
                    <div className="bg-white rounded-lg p-6 shadow-sm mb-8">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                            <select
                                ...
                                onChange={(e) => handleFilterChange("contentNiches", e.target.value)}
                    ...
                    {/* Featured Creators */}
                    <div className="mb-6">
                        <h2 className="text-xl font-semibold text-gray-900 mb-6">Featured Creators</h2>
